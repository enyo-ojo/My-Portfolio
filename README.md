...
🌱 [Plant Co. Quantity Performance](https://github.com/enyo-ojo/PlantCo-Quantity-Performance-Dashboard) | Sales & Operations Analytics · Performance Tracking | Power BI, DAX | Problem: Limited visibility into underperforming markets and product-level quantity trends. · Action: Built an interactive Power BI dashboard with year-over-year comparisons, segmentation, and country-level insights. · Result: Delivered an executive-friendly report to monitor profitability, identify lagging countries, and support strategic planning. 🔗 [Dashboard](#)
