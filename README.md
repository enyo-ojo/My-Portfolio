...
| ☎️📺 [Customer Churn Analysis & Prediction](https://github.com/enyo-ojo/Snowflake-Custormer-Churn--Analysis-and-Prediction) | Churn Analysis, Predictive Modelling, Word Cloud (Sentiment Analysis) | Analysis on Telco Customer Churn Kaggle Project. I performed a detailed exploratory data analysis using SQL in Snowflake warehousing. Then, feature engineering and statistical analysis and conducted modelling focusing on precision and recall for churned customer as the goal was to predict customer were likely to churnurn. |  pandas, matplotlib, plotly, nltk, xgboost(scikit-learn), numpy, imblearn |   
| ☎️📺 [Youtube Streamlit Dashboard](https://github.com/enyo-ojo/yt_dashboard_proj) | Data storytelling and Visualization |Created a streamlit dashboard to show data insights from a YouTube creators channel on their most popular videos, topics, and audience. This dashboard was my introduction to Snowflake's Streamlit platform, and it provided insights on the Creator's planning for YouTube videos and how to relate to their audience. [Dashboard](https://enyojo-first-st-app-youtubedashoard.streamlit.app/) |  pandas, mat, plotly, streamlit, datetime, numpy |  
